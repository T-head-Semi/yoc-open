 ...
 */
/* FIXME: SEMIHOST_READC is not support on XT DebugServer yet */
...
/**
 * @brief output the formated string like printf
 * attention: the iface called slowly,  instead of semihost_printf2 as as suggest
 * @param format format string
 * @param ... vargs
 *
 * @retval return the number of characters printed
 */
int semihost_printf(const char* format, ...);

/**
 * @brief output the formated string like printf
 * attention: max len of the output formated string according by CONFIG_SEMIHOST_PRINTF2_BUFSIZE
 * @param format format string
 * @param ... vargs
 *
 * @retval return the number of characters printed
